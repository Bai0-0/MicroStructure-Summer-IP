...
class get_x(object):
  ...
  def _init_(self,interval,data_file):
    self.interval, self.data = interval, data_file
...
def get_autocorr(interval=interval,
...
#%%
#Average Trade size and total trade amount
data_path = 'Data_File/Bond_Deal.csv'
...
# %% volatility and average time to maturity
...
df = pd.read_csv('Data_File/Bond_Deal.csv')
